    ...
    */
    ...
    public class QuadNode
    {
        ...
        private void Split()
        {
            ...
            var subSize = new TSVector2(subWidth, subHeight);

            nodes = new QuadNode[4];
            nodes[0] = new QuadNode(new Rectangle(bound.center + subSize, subSize), level + 1, this, 0);
            nodes[1] = new QuadNode(new Rectangle(bound.center + new TSVector2(-subSize.x, subSize.y), subSize), level + 1, this, 1);
            nodes[2] = new QuadNode(new Rectangle(bound.center - subSize, subSize), level + 1, this, 2);
            nodes[3] = new QuadNode(new Rectangle(bound.center - new TSVector2(-subSize.x, subSize.y), subSize), level + 1, this, 3);
        }
