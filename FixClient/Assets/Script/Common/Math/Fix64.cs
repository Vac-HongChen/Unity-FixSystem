...
namespace TrueSync
{
    ...
    public partial struct FP : IEquatable<FP>, IComparable<FP>
    {
        ...
        /// <summary>
        /// Returns a number indicating the sign of a FP number.
        ...
        /// <summary>
        /// Returns the absolute value of a FP number.
        /// Note: Abs(FP.MinValue) == FP.MaxValue.
        /// </summary>
        ...
        /// <summary>
        /// Returns the absolute value of a FP number.
        /// FastAbs(FP.MinValue) is undefined.
        /// </summary>
